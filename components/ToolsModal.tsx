    ...
    >
      ...
      >
        <div className="flex-shrink-0 p-4 sm:p-6 border-b border-white/10 flex justify-between items-center">
          <h2 id="tools-modal-title" className="text-xl sm:text-2xl font-bold text-gradient bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400">
            Nossas Ferramentas
          </h2>
              ...
              >
                 <div className="relative p-6 flex flex-col items-center text-center h-full">
                    <div className="mb-4 text-purple-400">
                        <PenToolIcon className="w-12 h-12 transition-transform duration-300 group-hover:scale-110" />
                    </div>
                    ...
                    <h3 className="font-bold text-lg text-brand-light mt-1 mb-2">{tool.title}</h3>
                    <p className="text-sm text-brand-gray flex-grow">{tool.description}</p>
                </div>
              </a>
            ))}
          </div>
